...
HIDDEN = [
    ...
    "lxml", "html5lib",
    # propios
    "database", "sheets_sync", "i18n",
    "scrapers", "scrapers.base", "scrapers.anilist", "scrapers.mal",
...
def build_app():
    step(1, "Compilando la app con PyInstaller")
    ...
    run([
        ...
        "--name",       "AnimeTracker",
        "--onedir",          # carpeta (más rápido de arrancar que --onefile)
...
def _write_installer_source(path: Path):
    ...
    code = textwrap.dedent(r'''
        ...
        TEXTS = {
            "es": {"title":"Instalar Anime Tracker","ver":"Versión {v}",
            ...
            "en": {"title":"Install Anime Tracker","ver":"Version {v}",
            ...
            "fr": {"title":"Installer Anime Tracker","ver":"Version {v}",
            ...
            "de": {"title":"Anime Tracker installieren","ver":"Version {v}",
        ...
        def register(install_dir: Path):
            try:
                ...
                with winreg.CreateKey(winreg.HKEY_CURRENT_USER, REG_KEY) as k:
                    ...
                    winreg.SetValueEx(k, "Publisher",       0, winreg.REG_SZ,    "Anime Tracker")
...
if __name__ == "__main__":
    print("\n  Anime Tracker — Build Script v4.0")
    print(f"  Python: {sys.executable}")
    ...
    print(f"\n{'=' * 60}")
    print(f"  LISTO. Comparte este archivo con tus usuarios:")
    print(f"  {SETUP_EXE}")
    print(f"{'=' * 60}\n")
